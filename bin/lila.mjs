...
const comandos = {
  ...
  'keystore:crear': () => crear(opciones.app, opciones),
  'keystore:respaldar': () => respaldar(opciones.app, opciones),
  'keystore:verificar': () => verificar(opciones.app, opciones),
  'keystore:huella': () => huella(opciones.app),
